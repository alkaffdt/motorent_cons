...
extension StyledText<T extends Text> on T {
  ...
  T smallSize() =>
      copyWith(style: (style ?? const TextStyle()).copyWith(fontSize: 12.0))
          as T;

  T regularSize() =>
      copyWith(style: (style ?? const TextStyle()).copyWith(fontSize: 14.0))
          as T;

  T mediumSize() =>
      copyWith(style: (style ?? const TextStyle()).copyWith(fontSize: 16.0))
          as T;
  ...
  T center() => copyWith(textAlign: TextAlign.center) as T;
  ...
  T fontHeight(double size) =>
      copyWith(style: (style ?? const TextStyle()).copyWith(height: size)) as T;
